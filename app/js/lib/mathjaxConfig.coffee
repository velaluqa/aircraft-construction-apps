...
MathJax.Hub.Config
  ...
  "HTML-CSS":
    ...
    tooltip:
      ...
      offsetX: 10 # pixels to offset tooltip from mouse position
      offsetY: 5
...
u = h.substr(0, h.lastIndexOf("/") + 1)
MathJax.Ajax.loadComplete u + "js/mathjaxConfig.js"
